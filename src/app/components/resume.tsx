...
export const CoverLetterAndResume = () => {
  ...
  const [coverLetterAndResume, setCoverLetterAndResume] = useState({
    letter: "",
    resume: "",
  });
  ...
  useMakeCopilotActionable(
    {
      ...
      implementation: async (coverLetterMarkdown, resumeMarkdown) => {
        setCoverLetterAndResume((prevState) => ({
          ...prevState,
  ...
  // Update Cover Letter
  const updatedCoverLetter = coverLetterAndResume.letter;

  useMakeCopilotReadable("Cover Letter:" + JSON.stringify(updatedCoverLetter));
  ...
  // Update Resume
  const updatedResume = coverLetterAndResume.resume;

  useMakeCopilotReadable("Resume:" + JSON.stringify(updatedResume));
  ...
  return <CoverLetterResume {...coverLetterAndResume} />;
};
